public class Cylinder extends Circle{
	...
	public double getArea() { //since volume and base area are explicitly listed in UML,
		...
		return 2 * 3.14159 * super.radius * this.height + 2* this.getBaseArea();
	}
	...
	public String toString() {
		return "Cylinder Information:\nbase radius=" + super.getRadius() + ", color=" + super.getColor() +", height=" + this.height + ", base area=" + this.getBaseArea() + "\nsurface area=" + this.getArea() + ", volume=" + this.getVolume();
	}
}
